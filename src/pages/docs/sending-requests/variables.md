...
1. Open a new request tab and enter `https://postman-echo.com/get?var={{my_variable}}` as the URL. Hover over the variable name to inspect the variable's value and scope.
    ...
    <img alt="View the variable value and scope" src="https://assets.postman.com/postman-docs/v10/variable-quick-start-hover-v10-21-2.jpg" />
...
![Environment editor](https://assets.postman.com/postman-docs/v10/environment-editor-v10-21-2.jpg)

<img alt="Reference variable" src="https://assets.postman.com/postman-docs/v10/reference-var-v10-21-2.jpg"/>
...
1. For environment or global variables, select **Edit** to open the editor.
    ...
    <img alt="Environment editor" src="https://assets.postman.com/postman-docs/v10/environment-editor-v10-21-2.jpg">
...
1. Select the data you need, for example in the address, parameters, headers, or body. Select **Set as variable**.
    ...
    <img src="https://assets.postman.com/postman-docs/v10/set-as-var-prompt-v10-21-2.jpg" alt="Set as variable"/>
...
1. Enter a **Name**, confirm the **Value** is correct, and select a scope. Select **Set variable**.
    ...
    <img src="https://assets.postman.com/postman-docs/v10/set-as-var-modal-v10-21-2.jpg" alt="Set as variable"/>
...
![Edit collection](https://assets.postman.com/postman-docs/v10/collection-variables-v10-21-2.jpg)
...
![Variable prompt](https://assets.postman.com/postman-docs/v10/var-prompt-v10-21-2.jpg)

The prompt indicates the current value, scope (highlighted by color), and overridden status where relevant.

![Overridden variable](https://assets.postman.com/postman-docs/v10/overridden-var-v10-21-2.jpg)
...
<img alt="Unresolved variable" src="https://assets.postman.com/postman-docs/v10/unresolved-variable-v10-21-2.jpg"/>
...
![Log a variable value](https://assets.postman.com/postman-docs/v10/log-var-v10-21-2.jpg)
